...
class ProyekPenelitianBlog(models.Model):
    ...
    funding_agency = fields.Char('Lembaga Pendana', help="Contoh: Kemendikbud, BRIN, Kemenristek")
    ...
    total_funding = fields.Float('Total Pendanaan (Rp)', help="Total nilai pendanaan semua proyek dalam kategori ini")
